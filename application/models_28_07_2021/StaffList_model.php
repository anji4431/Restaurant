...
class StaffList_model extends CI_Model
{
    ...
    var $column_order = array('rsr.id','rsr.name','rsr.email','rsr.mobile_no','rsr.aadhar_no','rsr.pan_number','rsr.permanent_address','rsr.user_type','rsr.create_date','rsr.status'); 
...
public function count_filtered()
 ...
 public function delete($user_id)
 {
  ...
  public function change($mobile_no,$status,$admin_id)
 {
  ...
  public function getStaff($mobile_no)
 {
    $this->db->select('*');
 ...
 public function updateStaff($array,$mobile_no)
{
    $this->db->where('mobile_no',$mobile_no);
