...
{    
    ...
    public function check_total_count_notification2($customer_mobile_no,$string)
     {
    ...
    {   
      ...
      // $this->db->query("UPDATE tbl_notification_by_customer SET status='0' where customer_mobile_no='$customer_mobile_no' and mobile_no IN($string)" );
