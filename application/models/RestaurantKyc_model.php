...
class RestaurantKyc_model extends CI_Model
{
    ...
    var $column_order = array('','s.name','md.registration_no','','md.licence_no','','md.shop_act_licenece_no','','md.uaid_no','','md.pan_no','','md.acc_no','md.ifsc'); 
    ...
    var $order = array('md.doc_id' => 'Desc');
   ...
   private function _get_datatables_query()
    {
          ...
          //  $select="*";
            ...
            $this->db->JOIN('spots AS s','md.doc_id=s.doc_id','LEFT');
